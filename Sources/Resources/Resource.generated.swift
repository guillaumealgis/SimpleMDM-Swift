...
extension Device: Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        osVersion = try attributes.decode(Version.self, forKey: .osVersion)
        ...
        batteryLevel = try attributes.decodeIfPresent(String.self, forKey: .batteryLevel)
        ...
        cellularTechnology = try attributes.decodeIfPresent(Int.self, forKey: .cellularTechnology)
        voiceRoamingEnabled = try attributes.decodeIfPresent(Bool.self, forKey: .voiceRoamingEnabled)
        dataRoamingEnabled = try attributes.decodeIfPresent(Bool.self, forKey: .dataRoamingEnabled)
        isRoaming = try attributes.decodeIfPresent(Bool.self, forKey: .isRoaming)
        ...
        hardwareEncryptionCaps = try attributes.decodeIfPresent(Int.self, forKey: .hardwareEncryptionCaps)
        passcodePresent = try attributes.decodeIfPresent(Bool.self, forKey: .passcodePresent)
        passcodeCompliant = try attributes.decodeIfPresent(Bool.self, forKey: .passcodeCompliant)
        passcodeCompliantWithProfiles = try attributes.decodeIfPresent(Bool.self, forKey: .passcodeCompliantWithProfiles)
        ...
        isSupervised = try attributes.decodeIfPresent(Bool.self, forKey: .isSupervised)
        ...
        isDeviceLocatorServiceEnabled = try attributes.decodeIfPresent(Bool.self, forKey: .isDeviceLocatorServiceEnabled)
        isDoNotDisturbInEffect = try attributes.decodeIfPresent(Bool.self, forKey: .isDoNotDisturbInEffect)
        personalHotspotEnabled = try attributes.decodeIfPresent(Bool.self, forKey: .personalHotspotEnabled)
        itunesStoreAccountIsActive = try attributes.decodeIfPresent(Bool.self, forKey: .itunesStoreAccountIsActive)
...
extension InstalledApp: Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        shortVersion = try attributes.decode(Version.self, forKey: .shortVersion)
